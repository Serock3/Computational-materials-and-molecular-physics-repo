...
plt.plot(dos[:,0],dos[:,1],label=str(sizes[5]))

dos=new_db[1+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[1]))

dos=new_db[6+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[6]))

dos=new_db[7+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[7]))

dos=new_db[9+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[9]))

dos=new_db[2+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[2]))

dos=new_db[4+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[4]))

dos=new_db[3+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[3]))

dos=new_db[0+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[0]))

dos=new_db[8+1].data['density-of-states']
plt.plot(dos[:,0],dos[:,1],label=str(sizes[8]))

plt.legend()
plt.xlabel('E [cm$^{-1}$]')
plt.ylabel('DOS [1/cm$^{-1}$]')
plt.tight_layout()
